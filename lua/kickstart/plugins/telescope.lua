  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      wk.add({
        ...
        { "<leader>eA", function() builtin.find_files({ cwd = "~/.aws", hidden = true, follow = true }) end, desc = "[A]WS", },
        { "<leader>ea", function() builtin.find_files({ cwd = "~/.config/alacritty", hidden = true, follow = true }) end, desc = "[a]lacritty", },
        { "<leader>ed", function() builtin.find_files({ cwd = "~/.dotfiles", hidden = true, file_ignore_patterns = { ".png$", ".svg$" } }) end, desc = "[d]dotfiles", },
        { "<leader>eD", function() builtin.find_files({ cwd = "~/Downloads", hidden = true }) end, desc = "[D]ownloads", },
        { "<leader>eg", "<cmd>e ~/.gitconfig<cr>", desc = "[g]itconfig", },
        { "<leader>eG", "<cmd>e ~/p.typ<cr>", desc = "[G]typist", },
        { "<leader>ei", function() builtin.find_files({ cwd = "~/.config/i3", follow = true }) end, desc = "[i]3", },
        { "<leader>er", function() builtin.find_files({ cwd = "~/.config/ranger", hidden = true, follow = true, file_ignore_patterns = { "plugins/", "__pycache__/"} }) end, desc = "[r]anger", },
        { "<leader>es", function() builtin.find_files({ cwd = "~/.ssh", hidden = true, follow = true }) end, desc = "[s]sh", },
        { "<leader>et", "<cmd>e ~/.tmux.conf<cr>", desc = "[t]mux", },
        { "<leader>eT", function() builtin.find_files({ cwd = "~/.config/tmuxinator", follow = true }) end, desc = "[T]muxinator", },
        { "<leader>eV", "<cmd>e ~/.vimrc<cr>", desc = "[V]im", },
        { "<leader>ev", function() builtin.find_files({ cwd = vim.fn.stdpath("config"), hidden = true, follow = true }) end, desc = "neo[v]im", },
        { "<leader>en", function() builtin.find_files({ cwd = "~/notes" }) end, desc = "[n]otes", },
        { "<leader>ew", function() builtin.find_files({ cwd = "~/vimwiki" }) end, desc = "[w]iki", },
        { "<leader>em", function() builtin.find_files({ cwd = "~/projects/meshbio/wiki" }) end, desc = "[m]eshbio wiki", },
      })
