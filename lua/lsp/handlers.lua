...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ly', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts)
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>lf', '<cmd>lua vim.lsp.buf.formatting()<CR>', opts)
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>li', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
