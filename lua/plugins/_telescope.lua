return {
    {
        ...
        config = function()
            ...
            local multiopen = require('utils.telescope_multiopen')
            ...
            telescope.setup({
                    ...
                    extensions = {
                        ...
                        command_palette = {
                            ...
                            {
                                "Notes",
                                { "Find Notes",        ":lua require('utils.telescope_commands').find_notes()",   1 },
                                { "Search/Grep Notes", ":lua require('utils.telescope_commands').grep_notes()",   1 },
                                { "Browse Notes",      ":lua require('utils.telescope_commands').browse_notes()", 1 },
                            },
                            {
                                "Projects",
                                { "Find Files Meshbio",  ":lua require('utils.telescope_commands').find_files_meshbio()", 1 },
                                { "Search/Grep Meshbio", ":lua require('utils.telescope_commands').grep_meshbio()",       1 },
                                { "Search Todos",        ":lua require('utils.telescope_commands').search_todos()",       1 },
                            },
                            {
                                "Toggle",
