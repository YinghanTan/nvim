...
" " NOTE: Does not work when you start Vim as usual and enterdiff mode using :diffthis
" if &diff
"     let s:is_started_as_vim_diff = 1
"     syntax off
"     setlocal nospell
...
"                 \ let w:_vsc_conflict_mark_match = matchadd('ErrorMsg', '\(<\|=\||\|>\)\{7\}\([^=].\+\)\?$') |
"                 \ endif
" augroup END
